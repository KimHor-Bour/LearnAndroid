...
import com.example.kessseller.Java.TabListener;
...
public class ItemTabType extends Fragment{
    LinearLayout linearLayout;
     private  Context context;
    RecyclerView recyclerView;
    List<DataTypeItem.DataType> dataTypes;
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        switch (i) {
                            case 0:
                                break;
                            case 1:
                                startActivity(new Intent(getActivity(),CreateItemTable.class));
                                break;
                            case 2:
                                startActivity(new Intent(getActivity(), CreateItemRoom.class));
                                break;
                            case 3:
                                startActivity(new Intent(getActivity(), CreateItemEvent.class));
                                break;
                        }
                    }
                });
