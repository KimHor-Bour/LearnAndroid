...
public class AdapterOfItemTable extends RecyclerView.Adapter<AdapterOfItemTable.DataViewHolder> {
    List<DataItemTableBooking.DataItemTable> dataItemTables;
    public AdapterOfItemTable(List<DataItemTableBooking.DataItemTable> dataItemTables) {
